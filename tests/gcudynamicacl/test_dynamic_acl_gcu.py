...
def dhcp_relay_default(ptfhost, dut_dhcp_relay_data, validate_dut_routes_exist, testing_config,
...
def test_gcu_acl_arp_rule_creation(rand_selected_dut, ptfadapter, setup, dynamic_acl_create_table, packets_for_test, ip_and_intf_info, proxy_arp_enabled):
    ...
    pytest_require(proxy_arp_enabled, "Proxy arp is not enabled")
...
def test_gcu_acl_dhcp_rule_creation(rand_selected_dut, ptfadapter, setup, dynamic_acl_create_table, ptfhost, dut_dhcp_relay_data, validate_dut_routes_exist, testing_config,
    ...
    dhcp_relay_default(ptfhost, dut_dhcp_relay_data, validate_dut_routes_exist, testing_config,
                            toggle_all_simulator_ports_to_rand_selected_tor_m)
